...
function MeetupItem(props) {
  const router = Object(router_["useRouter"])(); // const {meetupId} = router.query;
...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://vinhphucit:Annihilator.123...@cluster0.bou8u7f.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
